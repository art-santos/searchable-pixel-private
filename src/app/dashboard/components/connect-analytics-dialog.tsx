...
{`import { withCrawlerAnalytics } from '@split/analytics'

export const middleware = withCrawlerAnalytics({
  apiKey: process.env.SPLIT_API_KEY
              ...
              {selectedPlatform === 'custom' && (
                <>
                  <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg p-4">
                    <h4 className="font-medium text-white mb-3">API Integration</h4>
                    <p className="text-sm text-[#666] mb-3">
                      Send crawler visit data to our API endpoint:
                    </p>
                    <code className="block text-xs bg-[#1a1a1a] px-3 py-2 rounded font-mono text-[#888] mb-3">
                      POST https://api.split.dev/v1/crawler-visits
                    </code>
                    <div className="space-y-2">
                      <p className="text-sm text-[#ccc]">Example request:</p>
                      <pre className="text-xs bg-[#1a1a1a] px-3 py-2 rounded font-mono text-[#888] overflow-x-auto">
{`{
  "apiKey": "your-api-key",
  "domain": "example.com",
  "path": "/blog/post",
