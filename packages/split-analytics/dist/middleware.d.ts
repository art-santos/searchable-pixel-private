...
<<<<<<< HEAD
import { T as TrackerConfig, c as CrawlerInfo, U as UnknownCrawlerInfo } from './tracker-Bp_2fBD6.js';

interface MiddlewareConfig extends TrackerConfig {
=======
import { SplitConfig } from './index';
 ...
 * }
 */
export declare function createSplitMiddleware(config: MiddlewareConfig): (request: NextRequest) => Promise<NextResponse<unknown>>;
/**
 ...
 * }
 */
export declare function trackCrawlerVisit(request: NextRequest, config: SplitConfig): Promise<boolean>;
